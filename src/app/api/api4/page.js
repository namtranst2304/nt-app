...
export default function API4Page() {
  ...
  const handleSave = () => {
    ...
    localStorage.setItem('ntsync-api-4', JSON.stringify(apiData))
    setSaved(true)
  ...
  const handleDownload = () => {
    ...
    a.href = url
    a.download = `api-4-response-${new Date().toISOString().split('T')[0]}.json`
    a.click()
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">API 4 Testing</h1>
              <p className="text-gray-300">Photo and media API testing</p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button 
                  onClick={() => {
                    setUrl('https://jsonplaceholder.typicode.com/photos')
                    setMethod('POST')
                    setBody('{"title": "My Photo", "url": "https://example.com/photo.jpg", "thumbnailUrl": "https://example.com/thumb.jpg"}')
                  }}
