...
export default function API5Page() {
  ...
  const handleSave = () => {
    ...
    localStorage.setItem('ntsync-api-5', JSON.stringify(apiData))
    setSaved(true)
  ...
  const handleDownload = () => {
    ...
    a.href = url
    a.download = `api-5-response-${new Date().toISOString().split('T')[0]}.json`
    a.click()
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">API 5 Testing</h1>
              <p className="text-gray-300">Comments and interaction API testing</p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button 
                  onClick={() => {
                    setUrl('https://jsonplaceholder.typicode.com/comments')
                    setMethod('POST')
                    setBody('{"name": "John Doe", "email": "john@example.com", "body": "Great post!"}')
                  }}
